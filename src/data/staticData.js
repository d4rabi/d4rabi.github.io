...
export const educations =
    [
        ...
        {year: '2017 - 2024', name: 'Diponegoro University', detail: 'Major: Computer Science', score: 'GPA: 3.61/4'}
    ];
...
export const works =
    [
        {year: 'November 2020 - May 2021', role: 'BackEnd Developer Intern', company: 'CIMB Niaga Tbk', detail: 'Internship as a Software Engineer in the Engineering Development unit of CIMB Niaga. Received tasks to develop software for internal use of CIMB Niaga. Engaged with other software engineers to improve the quality of the software being worked on.', techstack: 'Spring Boot, Java, Maven, Trello'},
        {year: 'January 2019 - May 2019', role: 'Project Manager / FullStack Developer Intern', company: 'BPTIK KEMENDIKBUD Center Java Region', detail: 'Internship as project manager and full-stack developer, My team and I create a Human Resource Information System using the waterfall method.', techstack: 'CodeIgniter 3, Bootstrap 4, draw.io, AdobeXD'}
    ];

export const projects =
    [
        {name: 'Information System of PPID SMA N 1 Gunung Talang', role: 'FullStack Developer', techstack: 'Laravel, React', deployed: 'SMA N 1 Gunung Talang', detail: 'The PPID (Information and Documentation Management Officer) Information System of SMA N 1 Gunung Talang is a digital platform that facilitates access to public information for the community. This system facilitates the dissemination of data related to school activities, policies, and transparency reports. This system supports transparency and accountability in the implementation of education.'},
